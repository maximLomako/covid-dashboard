...
const input = document.querySelector('.content-leftSide-cases__input');
...
const Keyboard = {
  ...
  init() {
    ...
    document.querySelectorAll(".content-leftSide-cases__input").forEach(element => {
  ...
  _createKeys() {
    ...
    keyLayout.forEach(key => {
      ...
      switch (key.code) {
        ...
        case "mute":
          keyElement.classList.add("keyboard__key--wide");
          keyElement.innerHTML = this.properties.sound ? createIconHTML("vol") : createIconHTML("vol");
